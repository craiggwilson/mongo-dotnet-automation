    ...
    public class LocalReplicaSetConfigurationBuilderTests
    {
        ...
        public void Build_should_set_replica_set_name_to_default_when_unspecified()
        {
            var subject = new LocalReplicaSetConfigurationBuilder()
                .Port(27017, new LocalReplicaSetMongodConfigurationBuilder().BinPath(TestConfiguration.GetMongodPath()).Build());
        ...
        {
            var subject = new LocalReplicaSetConfigurationBuilder()
                .Port(30000, 30001, 30002, new LocalReplicaSetMongodConfigurationBuilder().BinPath(TestConfiguration.GetMongodPath()).Build());
